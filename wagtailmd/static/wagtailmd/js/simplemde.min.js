...
function togglePreview(e) {
    var t = e.codemirror, r = t.getWrapperElement(), n = r.previousSibling, i = e.toolbarElements.preview,
        o = e.constructor.markdown, l = r.lastChild;
...
function SimpleMDE(e) {
    if (e = e || {}, e.element) this.element = e.element; else if (null === e.element) return void console.log("SimpleMDE: Error. No element was found.");
...
!function (e) {
    ...
    function u(e) {
        ...
        for (var n = 0; n < r.length; ++n) {
            var i = r[n], o = t.appendChild(zi("div", null, "CodeMirror-gutter " + i));
    ...
    function N(e, t) {
        for (var r = t.viewport, n = !0; (n && e.options.lineWrapping && t.oldDisplayWidth != je(e) || (r && null != r.top && (r = {top: Math.min(e.doc.height + Ue(e.display) - Ve(e), r.top)}), t.visible = x(e.display, e.doc, r), !(t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo))) && T(e, t); n = !1) {
            D(e);
            var i = p(e);
            Ee(e), H(e, i), y(e, i)
        }
    ...
    function B(e, t) {
        var r = t.text.className, n = _(e, t);
    ...
    function $(e, t, r, n, i) {
        if (t.widgets) for (var o = P(r), l = 0, a = t.widgets; l < a.length; ++l) {
            var s = a[l], u = zi("div", [s.node], "CodeMirror-linewidget");
    ...
    function te(e) {
        for (var t = [], r = [], n = 0; n < e.doc.sel.ranges.length; n++) {
            var i = e.doc.sel.ranges[n].head.line, o = {anchor: Eo(i, 0), head: Eo(i + 1, 0)};
    ...
    function De(e, t, r, n) {
        for (var i, o = 0; o < t.ranges.length; o++) {
            var l = t.ranges[o], a = Oe(e, l.anchor, r, n), s = Oe(e, l.head, r, n);
    ...
    function Pe(e, t, r) {
        ...
        var o = e.display, l = e.doc, a = document.createDocumentFragment(), s = Ge(e.display), u = s.left,
            c = Math.max(o.sizerWidth, je(e) - o.sizer.offsetLeft) - s.right, h = t.from(), d = t.to();
    ...
    function Be(e) {
        ...
        if (t.frontier < t.first && (t.frontier = t.first), !(t.frontier >= e.display.viewTo)) {
            var r = +new Date + e.options.workTime, n = nl(t.mode, Re(e, t.frontier)), i = [];
    ...
    function Re(e, t, r) {
        ...
        var o = ze(e, t, r), l = o > n.first && Yn(n, o - 1).stateAfter;
    ...
    function Ke(e, t, r) {
        var n = e.options.lineWrapping, i = n && je(e);
    ...
    function Ye(e, t) {
        t = vn(t);
        var r = ei(t), n = e.display.externalMeasured = new Ot(e.doc, t, r);
        n.lineN = r;
    ...
    function rt(e, t, r, n) {
        ...
        if (3 == l.nodeType) {
            for (var c = 0; 4 > c; c++) {
                ...
                if (go && 9 > mo && 0 == a && s == o.coverEnd - o.coverStart) i = l.parentNode.getBoundingClientRect(); else if (go && e.options.lineWrapping) {
        ...
        if (go && 9 > mo && !a && (!i || !i.left && !i.right)) {
            ...
            i = d ? {left: d.left, right: d.left + yt(e.display), top: d.top, bottom: d.bottom} : Bo
        }
    ...
    function mt(e, t, r, n, i) {
        ...
        var l = i - ri(t), a = !1, s = 2 * e.display.wrapper.clientWidth, u = Je(e, t), c = ni(t), h = t.text.length,
            d = to(t), f = ro(t), p = o(d), g = a, m = o(f), v = a;
    ...
    function bt(e) {
        e.curOp = {
            ...
            focus: !1,
            id: ++Ro
        }, zo ? zo.ops.push(e.curOp) : e.curOp.ownsGroup = zo = {ops: [e.curOp], delayedCallbacks: []}
    }
    ...
    function Wt(e, t, r, n) {
        ...
        var i = e.display;
        if (n && r < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t), e.curOp.viewChanged = !0, t >= i.viewTo) Oo && bn(e.doc, t) < i.viewTo && Pt(e); else if (r <= i.viewFrom) Oo && xn(e.doc, r + n) > i.viewFrom ? Pt(e) : (i.viewFrom += n, i.viewTo += n); else if (t <= i.viewFrom && r >= i.viewTo) Pt(e); else if (t <= i.viewFrom) {
            var o = _t(e, r, r + n, 1);
            ...
            var l = _t(e, t, t, -1), a = _t(e, r, r + n, 1);
    ...
    function _t(e, t, r, n) {
        ...
        if (!Oo || r == e.doc.first + e.doc.size) return {index: o, lineN: r};
    ...
    function qt(t, r, n) {
        var i = n && n != e.Init;
        if (!r != !i) {
            var o = t.display.dragFunctions, l = r ? Ll : Ml;
    ...
    function Vt(e, t, r) {
        ...
        var o, l = e.doc.sel, a = Mo ? t.metaKey : t.ctrlKey;
    ...
    function Xt(e, t, r, n, i) {
        function o(t) {
            if (0 != Wo(m, t)) if (m = t, "rect" == n) {
                ...
                if ("single" != n) {
                    if ("double" == n) var C = e.findWordAt(t); else var C = new de(Eo(t.line, 0), me(u, Eo(t.line + 1, 0)));
        ...
        if (i && !t.shiftKey ? (h = u.sel.contains(r), c = h > -1 ? f[h] : new de(r, r)) : (c = u.sel.primary(), h = u.sel.primIndex), t.altKey) n = "rect", i || (c = new de(r, r)), r = $t(e, t, !0, !0), h = -1; else if ("double" == n) {
    ...
    function Qt(e) {
        ...
        if (tr(t), !ki(t, e) && !Gt(t.display, e)) {
            Cl(e), go && (qo = +new Date);
            var r = $t(t, e, !0), n = e.dataTransfer.files;
    ...
    function rr(e, t) {
        Math.abs(e.doc.scrollTop - t) < 2 || (e.doc.scrollTop = t, ho || A(e, {top: t}), e.display.scroller.scrollTop != t && (e.display.scroller.scrollTop = t), e.display.scrollbars.setScrollTop(t), ho && A(e), _e(e, 100))
    }
    ...
    function ir(e, t) {
        ...
        if (n && l.scrollWidth > l.clientWidth || i && l.scrollHeight > l.clientHeight) {
            ...
            if (n && !ho && !xo && null != Go) return i && rr(e, Math.max(0, Math.min(l.scrollTop + i * Go, l.scrollHeight - l.clientHeight))), nr(e, Math.max(0, Math.min(l.scrollLeft + n * Go, l.scrollWidth - l.clientWidth))), Cl(t), void (o.wheelStartX = null);
            if (i && null != Go) {
                var c = i * Go, h = e.doc.scrollTop, d = h + o.wrapper.clientHeight;
    ...
    function gr(e) {
        e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1), "nocursor" != e.options.readOnly && (e.state.focused || (Tl(e, "focus", e), e.state.focused = !0, jl(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(),
    ...
    function Cr(e, t, r) {
        for (var n = [], i = Eo(e.first, 0), o = i, l = 0; l < t.length; l++) {
            var a = t[l], s = wr(a.from, i, o), u = wr(Ko(a), i, o);
            if (i = a.to, o = u, "around" == r) {
                var c = e.sel.ranges[l], h = Wo(c.head, c.anchor) < 0;
        ...
        if (!e.cm || !e.cm.state.suppressEdits) {
            ...
            if (s != l.length) {
                ...
                for (var c = Mi(e, "beforeChange") || e.cm && Mi(e.cm, "beforeChange"), s = n.changes.length - 1; s >= 0; --s) {
                    ...
                    u.push(oi(e, h));
                    var d = s ? xr(e, h) : Hi(l);
                    Nr(e, h, d, ln(e, h)), !s && e.cm && e.cm.scrollIntoView({from: h.from, to: Ko(h)});
                    var f = [];
                    Kn(e, function (e, t) {
    ...
    function Ar(e, t, r) {
        ...
        var d = Mi(e, "changes"), f = Mi(e, "change");
        if (f || d) {
    ...
    function Wr(e, t, r, n, i) {
        ...
        var p = e.curOp && null != e.curOp.scrollLeft ? e.curOp.scrollLeft : o.scroller.scrollLeft,
            g = je(e) - (e.options.fixedGutter ? o.gutters.offsetWidth : 0), m = n - t > g;
    ...
    function _r(e, t, r, n) {
        ...
        var l = e.options.tabSize, a = Yn(o, t), s = Wl(a.text, null, l);
    ...
    function Ur(t, r, n, i) {
        e.defaults[t] = r, n && (Yo[t] = i ? function (e, t, r) {
            r != Zo && n(e, t, r)
        } : n)
    }
    ...
    function Vr(e, t, r, n, i) {
        n = Ii(n), n.shared = !1;
        var o = [jr(e, t, r, n, i)], l = o[0], a = n.widgetNode;
    ...
    function Yr(e) {
        for (var t = 0; t < e.length; t++) {
            ...
            for (var i = 0; i < r.markers.length; i++) {
                var o = r.markers[i];
                -1 == Di(n, o.doc) && (o.parent = null, r.markers.splice(i--, 1))
            }
        }
    }
    ...
    function nn(e, t) {
        ...
        if (!r && !n) return null;
        var i = t.from.ch, o = t.to.ch, l = 0 == Wo(t.from, t.to), a = tn(r, i, l), s = rn(n, o, l),
            u = 1 == t.text.length, c = Hi(t.text).length + (u ? i : 0);
    ...
    function an(e, t, r) {
        ...
        for (var i = [{
            ...
            if (!(Wo(u.to, a.from) < 0 || Wo(u.from, a.to) > 0)) {
                var c = [s, 1], h = Wo(u.from, a.from), d = Wo(u.to, a.to);
    ...
    function dn(e, t) {
        ...
        if (0 != r) return r;
        var n = e.find(), i = t.find(), o = Wo(n.from, i.from) || cn(e) - cn(t);
        if (o) return -o;
    ...
    function mn(e, t, r, n, i) {
        var o = Yn(e, t), l = Oo && o.markedSpans;
        if (l) for (var a = 0; a < l.length; ++a) {
            var s = l[a];
            if (s.marker.collapsed) {
                var u = s.marker.find(0), c = Wo(u.from, r) || cn(s.marker) - cn(i),
    ...
    function Dn(e, t, r, n) {
        function i(e) {
            return {start: h.start, end: h.pos, string: h.current(), type: o || null, state: e ? nl(l.mode, c) : c}
        }

        var o, l = e.doc, a = l.mode;
        t = me(l, t);
        var s, u = Yn(l, t.line), c = Re(e, t.line, r), h = new cl(u.text, e.options.tabSize);
        for (n && (s = []); (n || h.pos < t.ch) && !h.eol();) h.start = h.pos, o = Hn(a, h, c), n && s.push(i(!0));
        return n ? s : i()
    }
    ...
    function On(e, t, r, n, i, o, l) {
        ...
        var s, u = 0, c = null, h = new cl(t, e.options.tabSize), d = e.options.addModeClass && [null];
    ...
    function Wn(e, t, r) {
        if (!t.styles || t.styles[0] != e.state.modeGen) {
            var n = Re(e, ei(t)), i = En(e, t, t.text.length > e.options.maxHighlightLength ? nl(e.doc.mode, n) : n);
    ...
    function In(e, t, r, n) {
        var i = e.doc.mode, o = new cl(t, e.options.tabSize);
    ...
    function Fn(e, t) {
        var r = zi("span", null, null, vo ? "padding-right: .1px" : null), n = {
    ...
    function Bn(e, t, r, n, i, o, l) {
        if (t) {
            var a = e.splitSpaces ? t.replace(/ {3,}/g, zn) : t, s = e.cm.state.specialChars, u = !1;
            if (s.test(t)) for (var c = document.createDocumentFragment(), h = 0; ;) {
                ...
                if (!d) break;
                if (h += f + 1, "	" == d[0]) {
                    var g = e.cm.options.tabSize, m = g - e.col % g, p = c.appendChild(zi("span", Ai(m), "cm-tab"));
    ...
    function $n(e, t, r, n) {
        ...
        var a = t.from, s = t.to, u = t.text, c = Yn(e, a.line), h = Yn(e, s.line), d = Hi(u), f = i(u.length - 1),
            p = s.line - a.line;
    ...
    function oi(e, t) {
        var r = {from: V(t.from), to: Ko(t), text: Zn(e, t.from, t.to)};
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var a = 0; a < o.changes.length; ++a) {
                    var s = o.changes[a];
                    if (r < s.from.line) s.from = Eo(s.from.line + n, s.from.ch), s.to = Eo(s.to.line + n, s.to.ch); else if (t <= s.to.line) {
                        l = !1;
                        break
                    }
                }
    ...
    function Yi(e) {
        ...
        var t = qi(e, document.createTextNode("AخA")), r = _l(t, 0, 1).getBoundingClientRect();
    ...
    function Zi(e) {
        ...
        var t = qi(e, zi("span", "x")), r = t.getBoundingClientRect(), n = _l(t, 0, 1).getBoundingClientRect();
    ...
    function no(e, t) {
        ...
        n != r && (t = ei(n));
        var i = ni(n), o = i ? i[0].level % 2 ? ro(n) : to(n) : 0;
        return Eo(t, o)
    }

    function io(e, t) {
        for (var r, n = Yn(e.doc, t); r = gn(n);) n = r.find(1, !0).line, t = null;
        var i = ni(n), o = i ? i[0].level % 2 ? to(n) : ro(n) : n.text.length;
        return Eo(null == t ? ei(n) : t, o)
    }

    function oo(e, t) {
        var r = no(e, t.line), n = Yn(e.doc, r.line), i = ni(n);
        if (!i || 0 == i[0].level) {
    ...
    var ho = /gecko\/\d/i.test(navigator.userAgent), fo = /MSIE \d/.test(navigator.userAgent),
        po = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), go = fo || po,
        mo = go && (fo ? document.documentMode || 6 : po[1]), vo = /WebKit\//.test(navigator.userAgent),
        yo = vo && /Qt\/\d+\.\d+/.test(navigator.userAgent), bo = /Chrome\//.test(navigator.userAgent),
        xo = /Opera\//.test(navigator.userAgent), wo = /Apple Computer/.test(navigator.vendor),
        Co = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(navigator.userAgent), So = /PhantomJS/.test(navigator.userAgent),
        ...
        Mo = ko || /Mac/.test(navigator.platform), To = /win/i.test(navigator.platform),
        No = xo && navigator.userAgent.match(/Version\/(\d*\.\d*)/);
    No && (No = Number(No[1])), No && No >= 15 && (xo = !1, vo = !0);
    var Ao = Mo && (yo || xo && (null == No || 12.11 > No)), Ho = ho || go && mo >= 9, Do = !1, Oo = !1;
    g.prototype = Ii({
        update: function (e) {
    ...
    ne.prototype = Ii({
        init: function (e) {
            ...
            var n = this, i = n.cm, o = i.display, l = n.textarea, a = $t(i, e), s = o.scroller.scrollTop;
            if (a && !xo) {
        ...
        init: function (e) {
            function t(e) {
                if (n.somethingSelected()) Io = n.getSelections(), "cut" == e.type && n.replaceSelection("", null, "cut"); else {
                    if (!n.options.lineWiseCopyCut) return;
                    var t = te(n);
            ...
            for (var h = e.doc.splitLines(ce(e, a, c, l, u)), d = Zn(e.doc, Eo(l, 0), Eo(u, Yn(e.doc, u).text.length)); h.length > 1 && d.length > 1;) if (Hi(h) == Hi(d)) h.pop(), d.pop(), u--; else {
                if (h[0] != d[0]) break;
                h.shift(), d.shift(), l++
            }
            ...
            var w = Eo(l, f), C = Eo(u, d.length ? Hi(d).length - p : 0);
    ...
    var Po, Fo, _o, Bo = {left: 0, right: 0, top: 0, bottom: 0}, zo = null, Ro = 0, qo = 0, Uo = 0, Go = null;
    ...
    var jo = new Ni, Vo = null, Ko = e.changeEnd = function (e) {
    ...
    e.prototype = {
        constructor: e, focus: function () {
            ...
            for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                var i = t[n];
                if (i.empty()) i.head.line > r && (_r(this, i.head.line, e, !0), r = i.head.line, n == this.doc.sel.primIndex && Pr(this)); else {
        ...
        }, triggerOnKeyDown: Ht(cr), triggerOnKeyPress: Ht(fr), triggerOnKeyUp: dr, execCommand: function (e) {
            ...
            if (r) {
                ...
                for (var l = r.charAt(n), a = Fi(l, o) ? function (e) {
                    return Fi(e, o)
                } : /\s/.test(l) ? function (e) {
                    return /\s/.test(e)
                } : function (e) {
    ...
    var Xo = e.defaults = {}, Yo = e.optionHandlers = {}, Zo = e.Init = {
        toString: function () {
    ...
    e.defineMode = function (t, r) {
        ...
        if ("string" == typeof t && Jo.hasOwnProperty(t)) t = Jo[t]; else if (t && "string" == typeof t.name && Jo.hasOwnProperty(t.name)) {
            var r = Jo[t.name];
            "string" == typeof r && (r = {name: r}), t = Wi(r, t), t.name = r.name
        } else if ("string" == typeof t && /^[\w\-]+\/[\w\-]+\+xml$/.test(t)) return e.resolveMode("application/xml");
        return "string" == typeof t ? {
            name: t
        } : t || {name: "null"}
    }, e.getMode = function (t, r) {
        var r = e.resolveMode(r), n = Qo[r.name];
    ...
    e.registerHelper = function (t, r, n) {
        rl.hasOwnProperty(t) || (rl[t] = e[t] = {_global: []}), rl[t][r] = n
    }, e.registerGlobalHelper = function (t, r, n, i) {
        e.registerHelper(t, r, i), rl[t]._global.push({pred: n, val: i})
    };
        ...
        selectAll: function (e) {
            ...
            zr(e, function (t) {
                if (t.empty()) {
                    ...
                    } : {from: t.head, to: Eo(t.head.line, r)}
                }
                return {from: t.from(), to: t.to()}
            })
        }, deleteLine: function (e) {
            zr(e, function (t) {
                return {from: Eo(t.from().line, 0), to: me(e.doc, Eo(t.to().line + 1, 0))}
            })
        }, delLineLeft: function (e) {
            zr(e, function (e) {
                return {from: Eo(e.from().line, 0), to: e.from()}
            })
            ...
            for (var t = [], r = e.listSelections(), n = e.options.tabSize, i = 0; i < r.length; i++) {
                var o = r[i].from(), l = Wl(e.getLine(o.line), o.ch, n);
            ...
            Nt(e, function () {
                for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++) {
                    ...
                    if (o) if (i.ch == o.length && (i = new Eo(i.line, i.ch - 1)), i.ch > 0) i = new Eo(i.line, i.ch + 1), e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), Eo(i.line, i.ch - 2), i, "+transpose"); else if (i.line > e.doc.first) {
    ...
    var hl = 0, dl = e.TextMarker = function (e, t) {
    ...
    var hl = 0, fl = e.SharedTextMarker = function (e, t) {
                ...
                if (o >= e) {
                    if (i.insertInner(e, t, r), i.lines && i.lines.length > 50) {
                        for (; i.lines.length > 50;) {
                            var l = i.lines.splice(i.lines.length - 25, 25), a = new jn(l);
    ...
    var yl = 0, bl = e.Doc = function (e, t, r, n) {
    ...
    bl.prototype = Wi(Vn.prototype, {
        constructor: bl, iter: function (e, t, r) {
            ...
            var t = Eo(this.first, 0), r = this.first + this.size - 1;
            kr(this, {
                from: t,
    ...
    }, Nl = null, Al = 30, Hl = e.Pass = {
        toString: function () {
            return "CodeMirror.Pass"
        }
    }, Dl = {scroll: !1}, Ol = {origin: "*mouse"}, El = {origin: "+move"};
    ...
    e.defineMode("markdown", function (t, r) {
        ...
        function a(e, t) {
            var o = e.sol(), l = t.list !== !1, a = t.indentedCode;
        ...
        var w = e.modes.hasOwnProperty("xml"), C = e.getMode(t, w ? {name: "xml", htmlMode: !0} : "text/plain");
        ...
        var S = 0, k = "header", L = "comment", M = "quote", T = "variable-2", N = "variable-3", A = "keyword",
            H = "hr", D = "tag", O = "formatting", E = "link", W = "link", I = "link", P = "string", F = "em",
            _ = "strong", B = "strikethrough", z = /^([*\-_])(?:\s*\1){2,}\s*$/, R = /^[*\-+]\s+/,
            q = /^[0-9]+([.)])\s+/, U = /^\[(x| )\](?=\s)/, G = /^(#+)(?: |$)/, $ = /^ *(?:\={1,}|-{1,})\s*$/,
            j = /^[^#!\[\]*_\\<>` "'(~]+/, V = [], K = {
                startState: function () {
                    return {
                        f: a,
                    ...
                    return e.block == s ? {state: e.htmlState, mode: C} : e.localState ? {
                        state: e.localState,
                        mode: e.localMode
                    } : {state: e, mode: K}
    ...
    e.defineMode("gfm", function (t, r) {
        ...
        }, l = {underscoresBreakWords: !1, taskLists: !0, fencedCodeBlocks: !0, strikethrough: !0};
    ...
    e.defineMode("xml", function (t, r) {
        ...
        var x = t.indentUnit, w = r.multilineTagIndentFactor || 1, C = r.multilineTagIndentPastTag;
        null == C && (C = !0);
...
SimpleMDE.toolbar = toolbar, SimpleMDE.markdown = function (e) {
    return window.marked ? (this.options.singleLineBreaks !== !1 && marked.setOptions({breaks: !0}), marked(e)) : void 0
    ...
    if (e = e || this.options.toolbar, e && 0 !== e.length) {
        ...
        var n = this, i = {};
        n.toolbar = e;
        for (var t = 0; t < e.length; t++) ("guide" != e[t].name || n.options.toolbarGuideIcon !== !1) && !function (e) {
            var t;
